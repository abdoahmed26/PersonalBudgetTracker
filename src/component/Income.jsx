...
import { deleteAllIncome, deleteFromIncome } from './rtk/Income';
    ...
    return (
        <div className='my-10'>
            <div className="container">
                <h1 className='font-bold text-3xl mb-3'>Incomes</h1>
                <div>
                    {
                        income.length > 0 ? 
                        <div>
                                                    ...
                                                    odd:bg-[#F5F5F3] even:bg-white'>
                                                        ...
                                                        <td className='border'>
                                                            <div className='flex gap-3 py-2 justify-center'>
                                                                ...
                                                                <Link onClick={()=>dispatch(deleteFromIncome(ele))}
                            ...
                            <div className='mt-6'>
                                <Link onClick={()=>dispatch(deleteAllIncome())}
                            ...
                            <div className='flex flex-col md:flex-row justify-center items-center gap-5'>
                                ...
                                shadow-lg">
                                    <h2 className='text-black font-bold text-xl uppercase'>
                                        YOUR Income FEELS LONELY.
                                    </h2>
                                    <p className='text-center text-sm font-bodyFont sm:px-10'>
                                        Your Incomes lives to serve. Give it purpose - fill it with incomes .
                                    </p>
                                </div>
                            </div>
                        </div>
